...
public class PenEvent {
    public static final int DELAY_ENABLE_RAW_DRAWING_MILLS = 100; //DeviceInfoUtil.getVComInfo(ResManager.getAppContext())  //.isWideColorGamut(ResManager.getAppContext()) ?
                    //COLOR_DEVICE_PEN_RESUME_DELAY_TIME_MS : COMMON_PEN_RESUME_DELAY_TIME_MS;
    public static final int POPUP_RESUME_PEN_TIME_MS = 500; //DeviceInfoUtil.isWideColorGamut(ResManager.getAppContext()) ? 500 : 300;
