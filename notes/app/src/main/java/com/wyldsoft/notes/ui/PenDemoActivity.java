...
import com.wyldsoft.notes.action.CommonPenAction;
import com.wyldsoft.notes.action.RefreshScreenAction;
import com.wyldsoft.notes.bean.EraseArgs;
import com.wyldsoft.notes.data.ShapeFactory;
import com.wyldsoft.notes.databinding.ActivityPenDemoBinding;
import com.wyldsoft.notes.event.ActivityFocusChangedEvent;
import com.wyldsoft.notes.event.ApplyFastModeEvent;
import com.wyldsoft.notes.event.FloatButtonChangedEvent;
import com.wyldsoft.notes.event.FloatButtonMenuStateChangedEvent;
import com.wyldsoft.notes.event.FloatMenuStateChangeEvent;
import com.wyldsoft.notes.event.NotificationPanelChangeEvent;
import com.wyldsoft.notes.event.PenEvent;
import com.wyldsoft.notes.event.PopupWindowChangeEvent;
import com.wyldsoft.notes.event.StatusBarChangeEvent;
import com.wyldsoft.notes.receiver.GlobalDeviceReceiver;
import com.wyldsoft.notes.request.AddShapeRequest;
import com.wyldsoft.notes.request.AttachNoteViewRequest;
import com.wyldsoft.notes.request.BaseRequest;
import com.wyldsoft.notes.request.PartialRefreshRequest;
import com.wyldsoft.notes.request.PauseRawDrawingRenderRequest;
import com.wyldsoft.notes.request.PauseRawInputRenderRequest;
import com.wyldsoft.notes.request.ResumeRawDrawingRequest;
import com.wyldsoft.notes.request.StrokeErasingRequest;
import com.wyldsoft.notes.request.StrokesEraseFinishedRequest;
import com.wyldsoft.notes.shape.Shape;
import com.wyldsoft.notes.ui.popup.PenSettingPop;
import com.wyldsoft.notes.ui.view.FloatingMenuDragHandler;
import com.wyldsoft.notes.util.ShapeUtils;
